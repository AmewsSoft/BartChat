...
private class <init> extends <init>
{
    ...
    protected StanzaFilter getDataPacketFilter()
    {
        return new AndFilter(new StanzaFilter[] {
            new StanzaTypeFilter(org/jivesoftware/smackx/bytestreams/ibb/packet/Data), new er(InBandBytestreamSession.this, null)
        });
    }
    ...
    protected StanzaListener getDataPacketListener()
    {
        return new StanzaListener() {
            ...
            final InBandBytestreamSession.IQIBBInputStream this$1;
                ...
                throws org.jivesoftware.smack.SmackException.NotConnectedException
            {
                ...
                if (datapacketextension.getSeq() <= lastSequence)
                {
                    ...
                    InBandBytestreamSession.access$800(this$0).sendStanza(stanza);
                } else
                {
            ...
            {
                this$1 = InBandBytestreamSession.IQIBBInputStream.this;
                super();
                lastSequence = -1L;
            }
        };
